...
while True:
    ...
    if command == 'balance':
        ...
        atm.transactions.append(f"user checked balance of {balance}")
        ...
        if atm.check_withdrawal(amount): # call the check_withdrawal(amount) method
            ...
            atm.transactions.append(f"user did not have enough balance for ${amount} withdrawl")
    elif command == 'interest':
        amount = atm.calc_interest() # call the calc_interest() method
        atm.deposit(amount)
        print(f'Accumulated ${amount} in interest')
        atm.transactions.append(f"user checked interest earned of {amount}")
